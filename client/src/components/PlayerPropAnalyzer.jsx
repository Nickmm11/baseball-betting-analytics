...
const PlayerPropAnalyzer = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            if (propTypes.length > 0 && !currentPropType) {
    ...
    const calculatePerformance = () => {
        ...
        const totalGames = filteredProps.length;
        const gamesWithResult = filteredProps.filter(prop => prop.result !== null).length;
        ...
        return {
        hitRate: gamesWithResult ? (hitsOver / gamesWithResult * 100).toFixed(1) : 0,
        average: gamesWithResult ? (totalValues / gamesWithResult).toFixed(2) : 0,
        totalGames: gamesWithResult
        };
    };
